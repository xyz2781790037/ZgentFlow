...
type Model struct {
	...
	// APIConfigID references a reusable model API key. Empty means the model
	// uses its private Parameters.APIKey credential instead.
	APIConfigID string `yaml:"api_config_id" json:"api_config_id,omitempty" gorm:"column:api_config_id;type:varchar(36);index"`
