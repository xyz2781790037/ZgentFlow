...
const (
	...
	TypeKBFullRebuild        = "kb:full_rebuild"        // 向量全量重建
)
...
type KnowledgeMoveProgress struct {
	...
	SourceKBID string              `json:"source_kb_id"`
	TargetKBID string              `json:"target_kb_id"`
	Status     KnowledgeMoveStatus `json:"status"`
...
// KnowledgeMoveStatus represents the status of a knowledge move task.
type KnowledgeMoveStatus string

const (
	KnowledgeMoveStatusPending    KnowledgeMoveStatus = "pending"
	KnowledgeMoveStatusProcessing KnowledgeMoveStatus = "processing"
	KnowledgeMoveStatusCompleted  KnowledgeMoveStatus = "completed"
	KnowledgeMoveStatusFailed     KnowledgeMoveStatus = "failed"
)
