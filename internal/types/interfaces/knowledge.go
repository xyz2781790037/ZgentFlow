...
type KnowledgeService interface {
	...
	// Trash operations retain user-deleted documents for seven days.
	TrashKnowledge(ctx context.Context, id string) error
	TrashKnowledgeList(ctx context.Context, ids []string) error
	ListTrashedKnowledge(ctx context.Context) ([]*types.Knowledge, error)
	RestoreKnowledge(ctx context.Context, id string) error
	PurgeTrashedKnowledge(ctx context.Context, id string) error
	PurgeTrashedKnowledgeForTenant(ctx context.Context, tenantID uint64, id string) error
	...
	// Supports updating is_enabled and is_recommended.
...
type KnowledgeRepository interface {
	...
	GetTrashedKnowledge(ctx context.Context, tenantID uint64, id string) (*types.Knowledge, error)
	ListTrashedKnowledge(ctx context.Context, tenantID uint64) ([]*types.Knowledge, error)
	RestoreKnowledge(ctx context.Context, tenantID uint64, id string) error
	PurgeKnowledge(ctx context.Context, tenantID uint64, id string) error
	PurgeKnowledgeList(ctx context.Context, tenantID uint64, ids []string) error
	GetKnowledgeBatch(ctx context.Context, tenantID uint64, ids []string) ([]*types.Knowledge, error)
