...
func TestParseTenantIDFromStoragePath(t *testing.T) {
	tests := []struct {
		...
		{"s3://bucket/zealrag/1/abc/img.png", 1},
		{"cos://bucket/region/prefix/1/abc/img.png", 1},
		{"tos://bucket/1/abc/img.png", 1},
		{"oss://bucket/zealrag/1/abc/img.png", 1},
