...
// NewAsynqTaskInspector returns a TaskInspector wrapping the Redis inspector.
...
// tasks. All remaining pipeline payload types embed a json:"knowledge_id"
// field, so a single struct covers Document / PostProcess / Question / Summary.
...
// MUST include every queue any cancelable task type can land in.
