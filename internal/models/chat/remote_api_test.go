	...
	mcpTools := []Tool{
		{
			...
			Function: FunctionDef{
				...
				Description: "[External service: hazardous_chemicals] Get hazardous chemicals list",
		...
		},
		{
			...
			Function: FunctionDef{
				...
				Description: "[External service: hazardous_chemicals] Get hazardous chemical by biz ID",
