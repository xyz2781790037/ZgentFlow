...
func prepareChatModel(ctx context.Context, modelService interfaces.ModelService,
	...
	ctx = modelContext(ctx, chatManage)
...
func modelContext(ctx context.Context, chatManage *types.ChatManage) context.Context {
	if chatManage != nil && chatManage.ModelTenantID != 0 {
		return types.WithTenantID(ctx, chatManage.ModelTenantID)
	}
	return ctx
}
