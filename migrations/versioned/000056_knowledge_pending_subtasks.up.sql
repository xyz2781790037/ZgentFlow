...
-- (summary, question generation, Wiki generation) finish.
--
...
-- "expensive" tasks (question generation, summary, Wiki generation) were
-- still in flight. That broke the user's intuition
