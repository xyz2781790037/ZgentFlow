...
class TestPptConvert(unittest.TestCase):
    @unittest.skipUnless(LEGACY_PPT.is_file(), "external legacy PPT fixture is not included")
    ...
    @unittest.skipUnless(PPTX_SAMPLE.is_file(), "external PPTX fixture is not included")
