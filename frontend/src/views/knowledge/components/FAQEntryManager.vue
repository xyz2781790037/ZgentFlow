            ...
            <template v-else-if="entries.length > 0">
              <div ref="cardListRef" class="faq-card-list">
                <div v-for="entry in entries" :key="entry.id" class="faq-card"
                  ...
                  <!-- Card Footer -->
                  <div class="faq-card-footer"><div class="faq-card-status" @click.stop>
                      <!-- 暂时隐藏推荐开关
                      <t-tooltip
              ...
              <div class="faq-import-content">
                ...
                <div class="import-form-item">
                  ...
                  <div class="file-upload-wrapper">
                    <input ref="fileInputRef" type="file" accept=".csv,.xlsx,.xls" @change="handleFileChange"
...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 ZgentFlow？',
    answers: ['ZgentFlow 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['ZgentFlow 是什么？', '介绍一下 ZgentFlow'],
    negative_questions: ['这不是 ZgentFlow', '与 ZgentFlow 无关'],
  },
  {
...
const downloadCSVExample = () => {
  const headers = ['问题(必填)', '相似问题(选填-多个用##分隔)', '反例问题(选填-多个用##分隔)', '机器人回答(必填-多个用##分隔)', '是否全部回复(选填-默认FALSE)', '是否停用(选填-默认FALSE)', '是否禁止被推荐(选填-默认False 可被推荐)']
