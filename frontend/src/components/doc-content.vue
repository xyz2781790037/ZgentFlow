...
const TRACE_DRAWER_WIDTH_KEY = 'zealrag-trace-drawer-width';
...
// ============== 主抽屉（文档详情）宽度可调 ==============
const MAIN_DRAWER_WIDTH_KEY = 'zealrag-doc-drawer-width';
